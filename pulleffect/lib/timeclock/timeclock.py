...
from pulleffect.lib.timeclock.timeclock_models import TimeclockEntries
from pulleffect.lib.utilities import signin_required
from pulleffect.lib.utilities import sqla_session

timeclock = Blueprint('timeclock', __name__, template_folder='templates')

# Get table with timeclock entries
timeclock_entries = sqla_session.query(TimeclockEntries).all()
